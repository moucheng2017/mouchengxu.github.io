...
We propose a novel visual attention mechanism to learn to increase false positive detection and reverse false negative detection, in order to address over false negative detection caused by class imbalance biased towards background in segmentation.
